...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel-body">
        ...
        <asp:Button runat="server" ID="btnIndietroVeicolo" Text="Veicolo Precedente" CssClass="btn btn-default" OnClick="btnIndietroVeicolo_Click" />
        <asp:Button runat="server" ID="btnAvantiVeicolo" Text="Veicolo Successivo" CssClass="btn btn-default" OnClick="btnAvantiVeicolo_Click" />
