...
namespace NoleggioAuto.Web
{
    public partial class NuovoVeicolo : System.Web.UI.Page
    {
        ...
        protected void btnInserisci_Click(object sender, EventArgs e)
        {
            ...
            veicoloModel.DataImmatricolazione = txtDataImmatricolazione.SelectedDate;
        ...
        protected bool IsFormValido()
        {
            ...
            if (txtDataImmatricolazione.SelectedDate==DateTime.MinValue)
            {
                Messaggio = "La data selezionata non è esatta";
