...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <br />
            <div class="form-group">
                <label for="txtRicercaDataImmatricolazione">Data di immatricolazione</label>
                <asp:TextBox runat="server" ID="txtRicercaDataImmatricolazione" class="form-control date datepicker">
                </asp:TextBox>
            </div>
